...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyServerCodegen", date = "2018-12-23T18:09:07.883Z[GMT]")public abstract class CorpApiService {
    public abstract Response addDocument(UUID corpId,Body2 body,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response getPredicates(List<UUID> corpIds, String argument, String predicate,SecurityContext securityContext) throws NotFoundException;
